Track past changes in your AD accounts (users & computers), even if no event logs exist - e.g. past retension/overwritten, wiped (e.g. during an Incident Response) etc. Uses Replication metadata history parsing.
